...
public class PensionDisbursementServiceTests {
	ProcessPensionInput processPensionInput = new ProcessPensionInput(1234567891011786L, 1969.98, 500);
	ProcessPensionInput processPensionInput1 = new ProcessPensionInput(1234567891011121L, 1959.16, 550);
	ProcessPensionInput processPensionInput2 = new ProcessPensionInput(1234567891011120L, 1069.98, 550);
	ProcessPensionInput processPensionInput3 = new ProcessPensionInput(1234567891011124L, 1768.34, 550);
	ProcessPensionInput processPensionInput4 = new ProcessPensionInput(1234567891011125L, 782.23, 500);
	ProcessPensionInput processPensionInput5 = new ProcessPensionInput(1234567891011132L, 540.23, 550);
	ProcessPensionInput processPensionInput6 = new ProcessPensionInput(1234567891011170L, 1654.45, 550);
